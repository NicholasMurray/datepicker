export const CalendarIcon = () => {
  return (
    <div
      className="moj-datepicker__toggle moj-datepicker__toggle--mapps"
      aria-haspopup="dialog"
      aria-controls="datepicker-date"
      aria-expanded="false"
    >
      <span className="govuk-visually-hidden">Choose date</span>
      <svg
        width="32"
        height="24"
        focusable="false"
        className="moj-datepicker-icon"
        aria-hidden="true"
        role="img"
        viewBox="0 0 22 22"
      >
